...
<body>
    ...
    <div class="input-area">
        ...
        <form method="get" action="${pageContext.request.contextPath}/search">
            <input type="text" name="keyword" class="input-box" placeholder="궁금한 상품을 검색해보세요." value="${keyword}" />
            <button type="submit" class="search-btn">검색</button>
        </form>
    </div>

    <!-- 카테고리 목록 (부트스트랩 carousel) -->
    <div id="categoryCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="category-button-area">
                    <a href="${pageContext.request.contextPath}/goods/category" class="category-button-style">전체</a>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100 shadow-sm" onclick="location.href='${pageContext.request.contextPath}/goodspage/goodsDetail?goods_no=${goods.goods_no}'">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">하락률: ${goods.drop_rate}</p>
                    </div>
                </div>
            </div>
        </c:forEach>

		        <c:if test="${empty goodsListWish}">
		            <div class="col-12 text-center mt-5">
