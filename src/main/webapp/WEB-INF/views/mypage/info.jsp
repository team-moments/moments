  ...
  <div class="mypage-container">
    ...
    <main class="mypage-content">
      <div class="section">
        <h3>기본정보</h3>
        <div class="info-box">
          <div class="info-row" onclick="location.href='/mypage/userEdit?field=name'">
            <span>이름</span><span class="value">${user.name}</span><span class="arrow">></span>
          </div>
          <div class="info-row" onclick="location.href='/mypage/userEdit?field=phone'">
      ...
      <div class="section">
        <h3>계정 정보</h3>
        <div class="info-box">
          <div class="info-row" onclick="location.href='/mypage/userEdit?field=email'">
            <span>이메일</span><span class="value">${user.email}</span><span class="arrow">></span>
          </div>
          <div class="info-row" onclick="location.href='/mypage/userEdit?field=password'">
